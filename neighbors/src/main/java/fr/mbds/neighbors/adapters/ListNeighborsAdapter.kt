package fr.mbds.neighbors.adapters
...
class ListNeighborsAdapter(
    private val items: List<Neighbor>,
    val listHandler: ListNeighborHandler
) : RecyclerView.Adapter<ListNeighborsAdapter.ViewHolder>() {
    private var mNeighbours: MutableList<Neighbor> = items as MutableList<Neighbor>
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.mDeleteButton.setOnClickListener {
            listHandler.onDeleteNeighbor(neighbour)
        }
    }
